...
**MVP payment tối thiểu chốt:** ☑ Tiền mặt · ☑ Chuyển khoản · ☐ Thẻ (ghi nhận thủ công — MVP v2) · ☐ Ví (VNPay test pilot → tích hợp thật MVP v2)
...
| E-09 | B09   | P1      | Ví: MoMo hay ZaloPay ưu tiên? Quét QR khách hay merchant? | **Pilot:** TM+CK chính. **Dev/UAT:** VNPay Sandbox test tích hợp ví/cổng. **Go-live:** MoMo/ZaloPay hoặc VNPay production — sau pilot                                | Không dùng Sandbox thu tiền thật tại quán |
