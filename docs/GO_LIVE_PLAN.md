...
**Liên kết:** [RELEASE.md](RELEASE.md) · [DEPLOYMENT.md](DEPLOYMENT.md) · [TESTING.md](TESTING.md) · [DEVICE_POLICY.md](DEVICE_POLICY.md) · **GO_LIVE_PROMPTS_FULL.md (planned — chưa được tạo)** ← 183 prompt theo questionnaire
...
| ----------------------------------------------------------- | --------------------------------------------------------- | ------------------------------------------------ |
| **GO_LIVE_PROMPTS_FULL.md (planned — chưa được tạo)**       | **183 prompt** map 1:1 questionnaire A→I + GAP + US + UAT | Giao dev/AI **theo từng ID** (A-01, D-17, C-11…) |
...
1. Tìm ID trong Master Index của GO_LIVE_PROMPTS_FULL.md (planned — chưa được tạo) (vd. `D-17`, `B-14`).
...
- Bản **Doc Freeze Memo** (DOC_FREEZE_MEMO.md — planned, chưa được tạo; ngày freeze 2026-06-29, tag `docs-v2.0-mvp`).
- GAP tracker cập nhật (doc vs code) — Phần J questionnaire.
- Changelog nội bộ gửi team — [CHANGELOG.md](../CHANGELOG.md).
- API/ERD refactor checklist — API_ERD_REFACTOR_CHECKLIST.md (planned — chưa được tạo).
...
→ **FULL (183 ID):** GO_LIVE_PROMPTS_FULL.md (planned — chưa được tạo)  
...
- Repo-side demo pack: [DEMO_SCRIPT_INTERNAL.md](DEMO_SCRIPT_INTERNAL.md), DEMO_MINUTES_TEMPLATE.md (planned), [STAGING_DATA_CHECKLIST.md](STAGING_DATA_CHECKLIST.md), [NFR_SPOT_CHECK.md](NFR_SPOT_CHECK.md), COPY_REVIEW_PHASE3.md (planned).
...
- Repo-side UAT pack: UAT_SIGNOFF_SHEET.md (planned), UAT_REPORT_TEMPLATE.md (planned), EAS `preview` profile, `phase4:release-ready`.
...
- Repo-side pilot pack: PILOT_DAILY_LOG_TEMPLATE.md (planned), ON_CALL_ROSTER_TEMPLATE.md (planned), GO_NO_GO_MEMO_TEMPLATE.md (planned).
...
- Repo-side go-live pack: [PRODUCTION_DATA_CHECKLIST.md](PRODUCTION_DATA_CHECKLIST.md), GO_LIVE_ANNOUNCEMENT_TEMPLATE.md (planned), `phase8:smoke`, EAS `production` profile.
...
- Repo-side hypercare pack: WEEKLY_STABILITY_REPORT_TEMPLATE.md (planned), POSTMORTEM_TEMPLATE.md (planned), ROADMAP_V2_1_TEMPLATE.md (planned).
...
> **Prompt đầy đủ theo questionnaire (A-01 → I-09, GAP, US, UAT):** GO_LIVE_PROMPTS_FULL.md (planned — chưa được tạo) — **183 task**.  
...
| GO_LIVE_PROMPTS_FULL.md (planned — chưa được tạo)            | **183 prompt** map questionnaire A→I + GAP      |
